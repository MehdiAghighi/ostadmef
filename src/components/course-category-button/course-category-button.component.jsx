      ...
      <div className="course-category-button mx-1 my-1">
        ...
        >
          <div class="bg-white text-center border rounded-full relative">
            ...
            >
              <div
                className={`bg-${category.color}-400 text-center py-4 px-4 rounded-full bg-change-${category.color}`}
              >
                <img
                  width="50"
                  height="50"
          ...
          <div class="sc_studi_cats_info text-center relative z-10 font-bold">
