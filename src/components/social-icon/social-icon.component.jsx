...
export const TwitterButton = (props) => (
   <Link to={`https://${process.env.REACT_APP_TWITTER_URL}`}>
      <div
...
export const InstagramButton = (props) => (
   <Link to={`https://${process.env.REACT_APP_INSTAGRAM_URL}`}>
      <div
         className="py-3 px-3 bg-purple-800 text-white mx-2"
         style={{ borderRadius: "19px 4px 4px 4px" }}
      >
...
export const FacebookButton = (props) => (
   <Link to={`https://${process.env.REACT_APP_FACEBOOK_URL}`}>
      <div
         className="py-3 px-3 bg-purple-800 text-white mx-2"
         style={{ borderRadius: "19px 4px 4px 4px" }}
      >
...
export const TelegramButton = (props) => (
   <Link to={`https://${process.env.REACT_APP_TELEGRAM_URL}`}>
      <div
         className="py-3 px-3 bg-purple-800 text-white mx-2"
         style={{ borderRadius: "19px 4px 4px 4px" }}
      >
